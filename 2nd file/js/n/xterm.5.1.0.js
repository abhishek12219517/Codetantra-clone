    ...
    return (() => {
        ...
        var e = {
            4567: (e, t, i) => {
                ...
                const s = i(8055), r = i(7239), n = s.css.toColor("#ffffff"), o = s.css.toColor("#000000"),
                    a = s.css.toColor("#ffffff"), h = s.css.toColor("#000000"),
                    c = {css: "rgba(255, 255, 255, 0.3)", rgba: 4294967117};
                t.DEFAULT_ANSI_COLORS = Object.freeze((() => {
                    ...
                    for (let i = 0; i < 216; i++) {
                        ...
                        e.push({css: s.channels.toCss(r, n, o), rgba: s.channels.toRgba(r, n, o)})
                    }
                    for (let t = 0; t < 24; t++) {
                        const i = 8 + 10 * t;
                        e.push({css: s.channels.toCss(i, i, i), rgba: s.channels.toRgba(i, i, i)})
                    }
                    return e
                    ...
                    _parseColor(e, t, i = this.allowTransparency) {
                        ...
                        if (255 !== r[3]) {
                            ...
                            const [r, n, o, a] = this._ctx.fillStyle.substring(5, this._ctx.fillStyle.length - 1).split(",").map((e => Number(e))),
                                h = Math.round(255 * a);
                            return {rgba: s.channels.toRgba(r, n, o, h), css: e}
                        }
                        return {css: this._ctx.fillStyle, rgba: s.channels.toRgba(r[0], r[1], r[2], r[3])}
                    }
                }
            }, 9631: (e, t) => {
                Object.defineProperty(t, "__esModule", {value: !0}), t.removeElementFromParent = void 0, t.removeElementFromParent = function (...e) {
                    var t;
                ...
                let c = class extends a.Disposable {
                    ...
                    _linkAtPosition(e, t) {
                        const i = e.range.start.y === e.range.end.y, s = e.range.start.y < t.y, r = e.range.end.y > t.y;
                ...
                let a = class {
                    ...
                    provideLinks(e, t) {
                        ...
                        const r = [], o = this._optionsService.rawOptions.linkHandler, a = new n.CellData,
                        ...
                        for (let t = 0; t < c; t++) if (-1 !== d || s.hasContent(t)) {
                            ...
                            if (_ || -1 !== d && t === c - 1) {
                                ...
                                if (s) {
                                    const i = {start: {x: d + 1, y: e}, end: {x: t + (_ || t !== c - 1 ? 0 : 1), y: e}};
                                    r.push({
                                        text: s,
                                        range: i,
                ...
                const s = i(2950), r = i(1680), n = i(3614), o = i(2584), a = i(5435), h = i(9312), c = i(6114),
                    l = i(3656), d = i(9042), _ = i(4567), u = i(1296), f = i(7399), v = i(8460), g = i(8437),
                    p = i(5680), S = i(3230), m = i(4725), C = i(428), b = i(8934), y = i(6465), w = i(5114),
                    E = i(8969), L = i(8055), R = i(4269), k = i(5941), D = i(3107), A = i(5744), x = i(9074),
                    B = i(2585), T = i(2962), M = "undefined" != typeof window ? window.document : null;
                ...
                class O extends E.CoreTerminal {
                    ...
                    dispose() {
                        var e, t, i;
                        this._isDisposed || (super.dispose(), null === (e = this._renderService) || void 0 === e || e.dispose(), this._customKeyEventHandler = void 0, this.write = () => {
                        }, null === (i = null === (t = this.element) || void 0 === t ? void 0 : t.parentNode) || void 0 === i || i.removeChild(this.element))
                    }
                    ...
                    _syncTextArea() {
                        ...
                        const i = Math.min(this.buffer.x, this.cols - 1),
                            s = this._renderService.dimensions.actualCellHeight, r = t.getWidth(i),
                    ...
                    bindMouse() {
                        ...
                        const s = {mouseup: null, wheel: null, mousedrag: null, mousemove: null}, r = {
                        ...
                        }), {passive: !1})), this.register((0, l.addDisposableDomListener)(t, "touchstart", (e => {
                            if (!this.coreMouseService.areMouseEventsActive) return this.viewport.onTouchStart(e), this.cancel(e)
                        }), {passive: !0})), this.register((0, l.addDisposableDomListener)(t, "touchmove", (e => {
                    ...
                    getSelectionPosition() {
                        if (this._selectionService && this._selectionService.hasSelection) return {
                            ...
                            end: {x: this._selectionService.selectionEnd[0], y: this._selectionService.selectionEnd[1]}
                        }
                    }
                ...
                const n = i(5871), o = i(3656), a = i(4725), h = i(844), c = i(2585),
                    l = {full: 0, left: 0, center: 0, right: 0}, d = {full: 0, left: 0, center: 0, right: 0},
                ...
                function i(e, t, i) {
                    const s = i.getBoundingClientRect(), r = e.getComputedStyle(i),
                ...
                function r(e, t, i, s) {
                    const r = e - n(i, e), a = t - n(i, t), l = Math.abs(r - a) - function (e, t, i) {
                        let s = 0;
                        const r = e - n(i, e), a = t - n(i, t);
                ...
                function n(e, t) {
                    let i = 0, s = e.buffer.lines.get(t), r = null == s ? void 0 : s.isWrapped;
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.excludeFromContrastRatioDemands = t.isRestrictedPowerlineGlyph = t.isPowerlineGlyph = t.throwIfFalsy = void 0, t.throwIfFalsy = function (e) {
                ...
                const n = i(3787), o = i(8036), a = i(844), h = i(4725), c = i(2585), l = i(8460), d = i(8055),
                    _ = i(9631), u = "xterm-dom-renderer-owner-", f = "xterm-focus";
                let v = 1, g = class extends a.Disposable {
                    ...
                    onSelectionChanged(e, t, i) {
                        ...
                        const s = e[1] - this._bufferService.buffer.ydisp, r = t[1] - this._bufferService.buffer.ydisp,
                            n = Math.max(s, 0), o = Math.min(r, this._bufferService.rows - 1);
                    ...
                    renderRows(e, t) {
                        ...
                        for (let n = e; n <= t; n++) {
                            ...
                            e.innerText = "";
                            const t = n + this._bufferService.buffer.ydisp, o = this._bufferService.buffer.lines.get(t),
                ...
                const n = i(8036), o = i(643), a = i(511), h = i(2585), c = i(8055), l = i(4725), d = i(4269),
                    _ = i(1752), u = i(3734);
                ...
                const n = i(6193), o = i(8460), a = i(844), h = i(5596), c = i(3656), l = i(2585), d = i(4725);
                let _ = class extends a.Disposable {
                    constructor(e, t, i, s, r, a, l, d) {
                        if (super(), this._renderer = e, this._rowCount = t, this._charSizeService = r, this._isPaused = !1, this._needsFullRefresh = !1, this._isNextRenderRedrawOnly = !0, this._needsSelectionRefresh = !1, this._canvasWidth = 0, this._canvasHeight = 0, this._selectionState = {
                            ...
                            const e = new d.window.IntersectionObserver((e => this._onIntersectionChange(e[e.length - 1])), {threshold: 0});
                            e.observe(i), this.register({dispose: () => e.disconnect()})
                        }
                    }
                    ...
                    _renderRows(e, t) {
                        ...
                        }), this._onRender.fire({start: e, end: t}), this._isNextRenderRedrawOnly = !0
                    }
                ...
                const n = i(6114), o = i(456), a = i(511), h = i(8460), c = i(4725), l = i(2585), d = i(9806),
                    _ = i(9504), u = i(844), f = i(4841), v = String.fromCharCode(160), g = new RegExp(v, "g");
                let p = class extends u.Disposable {
                    ...
                    _isClickInSelection(e) {
                        const t = this._getMouseBufferCoords(e), i = this._model.finalSelectionStart,
                    ...
                    _getWordAt(e, t, i = !0, s = !0) {
                        ...
                        let a = this._convertViewportColToCharacterIndex(n, e), h = a;
                        const c = e[0] - a;
                        let l = 0, d = 0, _ = 0, u = 0;
                        if (" " === o.charAt(a)) {
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.ICharacterJoinerService = t.ISelectionService = t.IRenderService = t.IMouseService = t.ICoreBrowserService = t.ICharSizeService = void 0;
                const s = i(8343);
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.contrastRatio = t.toPaddedHex = t.rgba = t.rgb = t.css = t.color = t.channels = void 0, function (e) {
                    ...
                    function t(e, t) {
                        const s = Math.round(255 * t), [n, o, a] = r.toChannels(e.rgba);
                        return {css: i.toCss(n, o, a, s), rgba: i.toRgba(n, o, a, s)}
                    }

                    e.blend = function (e, t) {
                        const s = (255 & t.rgba) / 255;
                        if (1 === s) return {css: t.css, rgba: t.rgba};
                        const r = t.rgba >> 24 & 255, n = t.rgba >> 16 & 255, o = t.rgba >> 8 & 255,
                            a = e.rgba >> 24 & 255, h = e.rgba >> 16 & 255, c = e.rgba >> 8 & 255,
                            l = a + Math.round((r - a) * s), d = h + Math.round((n - h) * s),
                            _ = c + Math.round((o - c) * s);
                        return {css: i.toCss(l, d, _), rgba: i.toRgba(l, d, _)}
                        ...
                        const t = (255 | e.rgba) >>> 0, [s, n, o] = r.toChannels(t);
                        return {css: i.toCss(s, n, o), rgba: t}
                    ...
                    if (e.match(/#[0-9a-f]{3,8}/i)) switch (e.length) {
                        case 4: {
                            const t = parseInt(e.slice(1, 2).repeat(2), 16), i = parseInt(e.slice(2, 3).repeat(2), 16),
                                s = parseInt(e.slice(3, 4).repeat(2), 16);
                            return r.toColor(t, i, s)
                        }
                        case 5: {
                            const t = parseInt(e.slice(1, 2).repeat(2), 16), i = parseInt(e.slice(2, 3).repeat(2), 16),
                                s = parseInt(e.slice(3, 4).repeat(2), 16), n = parseInt(e.slice(4, 5).repeat(2), 16);
                    ...
                    if (t) {
                        const e = parseInt(t[1]), i = parseInt(t[2]), s = parseInt(t[3]),
                    ...
                    function t(e, t, i) {
                        const r = e >> 24 & 255, n = e >> 16 & 255, a = e >> 8 & 255;
                        let h = t >> 24 & 255, c = t >> 16 & 255, l = t >> 8 & 255,
                    ...
                    e.ensureContrastRatio = function (e, i, n) {
                        const a = s.relativeLuminance(e >> 8), h = s.relativeLuminance(i >> 8);
                        if (o(a, h) < n) {
                            if (h < a) {
                                const h = t(e, i, n), c = o(a, s.relativeLuminance(h >> 8));
                                if (c < n) {
                                    const t = r(e, i, n);
                            ...
                            const c = r(e, i, n), l = o(a, s.relativeLuminance(c >> 8));
                            if (l < n) {
                                const r = t(e, i, n);
                        ...
                        return {css: i.toCss(e, t, s, r), rgba: i.toRgba(e, t, s, r)}
                    }
                }(r = t.rgba || (t.rgba = {})), t.toPaddedHex = n, t.contrastRatio = o
            }, 8969: (e, t, i) => {
                Object.defineProperty(t, "__esModule", {value: !0}), t.CoreTerminal = void 0;
                const s = i(844), r = i(2585), n = i(4348), o = i(7866), a = i(744), h = i(7302), c = i(6975),
                    l = i(8460), d = i(1753), _ = i(3730), u = i(1480), f = i(7994), v = i(9282), g = i(5435),
                    p = i(5981), S = i(2660);
                let m = !1;
                ...
                class C extends s.Disposable {
                    ...
                    _enableWindowsMode() {
                        if (!this._windowsMode) {
                            const e = [];
                            e.push(this.onLineFeed(v.updateWindowsModeWrappedState.bind(null, this._bufferService))), e.push(this.registerCsiHandler({final: "H"}, (() => ((0, v.updateWindowsModeWrappedState)(this._bufferService), !1)))), this._windowsMode = {
                                dispose: () => {
                ...
                const s = i(2584), r = i(7116), n = i(2015), o = i(844), a = i(482), h = i(8437), c = i(8460),
                    l = i(643), d = i(511), _ = i(3734), u = i(2585), f = i(6242), v = i(6351), g = i(5941),
                    p = {"(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2}, S = 131072;
                ...
                class b extends o.Disposable {
                    ...
                    print(e, t, i) {
                        ...
                        const n = this._charsetService.charset, o = this._optionsService.rawOptions.screenReaderMode,
                            h = this._bufferService.cols, c = this._coreService.decPrivateModes.wraparound,
                            d = this._coreService.modes.insertMode, _ = this._curAttrData;
                    ...
                    requestMode(e, t) {
                        const i = this._coreService.decPrivateModes, {
                                activeProtocol: r,
                                activeEncoding: n
                            } = this._coreMouseService, o = this._coreService, {
                                buffers: a,
                                cols: h
                            } = this._bufferService, {active: c, alt: l} = a, d = this._optionsService.rawOptions,
                            _ = e => e ? 1 : 2, u = e.params[0];
                    ...
                    setOrReportIndexedColor(e) {
                        ...
                        for (; i.length > 1;) {
                            ...
                            if (/^\d+$/.exec(e)) {
                                const i = parseInt(e);
                                if (0 <= i && i < 256) if ("?" === s) t.push({type: 0, index: i}); else {
                    ...
                    requestStatusString(e, t) {
                        const i = this._bufferService.buffer, r = this._optionsService.rawOptions;
                ...
                const i = "undefined" == typeof navigator, s = i ? "node" : navigator.userAgent,
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.concat = t.fillFallback = t.fill = void 0, t.fill = function (e, t, s, r) {
                ...
                t.updateWindowsModeWrappedState = function (e) {
                    const t = e.buffer.lines.get(e.buffer.ybase + e.buffer.y - 1),
                        i = null == t ? void 0 : t.get(e.cols - 1), r = e.buffer.lines.get(e.buffer.ybase + e.buffer.y);
                ...
                const s = i(6349), r = i(8437), n = i(511), o = i(643), a = i(4634), h = i(4863), c = i(7116),
                    l = i(3734);
                t.MAX_BUFFER_SIZE = 4294967295, t.Buffer = class {
                    ...
                    resize(e, t) {
                        const i = this.getNullCell(r.DEFAULT_ATTR_DATA), s = this._getCorrectBufferLength(t);
                    ...
                    _reflowSmaller(e, t) {
                        ...
                        for (let o = this.lines.length - 1; o >= 0; o--) {
                            ...
                            const d = c[c.length - 1].getTrimmedLength(),
                                _ = (0, a.reflowSmallerGetNewLineLengths)(c, this._cols, e), u = _.length - c.length;
                            let f;
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.getWrappedLineTrimmedLength = t.reflowSmallerGetNewLineLengths = t.reflowLargerApplyNewLayout = t.reflowLargerCreateNewLayout = t.reflowLargerGetLinesToRemove = void 0, t.reflowLargerGetLinesToRemove = function (e, t, s, r, n) {
                    ...
                    for (let o = 0; o < e.length; o++) if (r === o) {
                        const i = t[++s];
                        e.onDeleteEmitter.fire({index: o - n, amount: i}), o += i - 1, n += i, r = t[++s]
                    } else i.push(o);
                ...
                t.evaluateKeyboardEvent = function (e, t, i, n) {
                    ...
                    switch (e.keyCode) {
                        ...
                        case 123:
                            ...
                            break;
                        default:
                            if (!e.ctrlKey || e.shiftKey || e.altKey || e.metaKey) if (i && !n || !e.altKey || e.metaKey) !i || e.altKey || e.ctrlKey || e.shiftKey || !e.metaKey ? e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && 1 === e.key.length ? o.key = e.key : e.key && e.ctrlKey && ("_" === e.key && (o.key = s.C0.US), "@" === e.key && (o.key = s.C0.NUL)) : 65 === e.keyCode && (o.type = 1); else {
                ...
                const s = i(8460), r = "undefined" == typeof queueMicrotask ? e => {
                ...
                const s = i(844), r = i(8273), n = i(8742), o = i(6242), a = i(6351);
                ...
                t.VT500_TRANSITION_TABLE = function () {
                    const e = new h(4095), t = Array.apply(null, Array(256)).map(((e, t) => t)),
                        i = (e, i) => t.slice(e, i), s = i(32, 127), r = i(0, 24);
                ...
                class l extends s.Disposable {
                    constructor(e = t.VT500_TRANSITION_TABLE) {
                        super(), this._transitions = e, this._parseStack = {
                            ...
                            transition: 0,
                            chunkPos: 0
                        }, this.initialState = 0, this.currentState = this.initialState, this._params = new n.Params, this._params.addParam(0), this._collect = 0, this.precedingCodepoint = 0, this._printHandlerFb = (e, t, i) => {
                        }, this._executeHandlerFb = e => {
                        }, this._csiHandlerFb = (e, t) => {
                        }, this._escHandlerFb = e => {
                        }, this._errorHandlerFb = e => e, this._printHandler = this._printHandlerFb, this._executeHandlers = Object.create(null), this._csiHandlers = Object.create(null), this._escHandlers = Object.create(null), this._oscParser = new o.OscParser, this._dcsParser = new a.DcsParser, this._errorHandler = this._errorHandlerFb, this.registerEscHandler({final: "\\"}, (() => !0))
                    }
                ...
                const n = i(2585), o = i(8460), a = i(1439), h = i(844), c = Object.freeze({insertMode: !1}),
                    l = Object.freeze({
                ...
                const s = i(8055), r = i(8460), n = i(844), o = i(6106), a = {xmin: 0, xmax: 0};
                ...
                let o = class {
                    ...
                    registerLink(e) {
                        ...
                        if (void 0 === e.id) {
                            const i = t.addMarker(t.ybase + t.y), s = {data: e, id: this._nextId++, lines: [i]};
                ...
                function i(e, t, i) {
                    t.di$target === t ? t.di$dependencies.push({id: e, index: i}) : (t.di$dependencies = [{
                        id: e,
                        index: i
                    }], t.di$target = t)
                }
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.IDecorationService = t.IUnicodeService = t.IOscLinkService = t.IOptionsService = t.ILogService = t.LogLevelEnum = t.IInstantiationService = t.IDirtyRowService = t.ICharsetService = t.ICoreService = t.ICoreMouseService = t.IBufferService = void 0;
                const s = i(8343);
                var r;
        ...
        return (() => {
            ...
            const t = i(3236), r = i(9042), n = i(7975), o = i(7090), a = i(5741), h = i(8285), c = ["cols", "rows"];
            e.Terminal = class {
                constructor(e) {
